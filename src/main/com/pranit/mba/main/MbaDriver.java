...
public class MbaDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		String filePath =  outputDir + "/all-frequent-itemsets/freq-list";
		...
		//jobAssociationRuleMining();   //Post processing, omitfor now
	...
	private void jobFrequentItemsetMining(int minSupportCount) throws IOException, ClassNotFoundException, InterruptedException {
		String hdfsInputPath =  inputDir;
		String hdfsOutputPath =  outputDir + "/output-pass-";
		boolean success;
	...
	private void jobAssociationRuleMining() throws IOException, ClassNotFoundException, InterruptedException {
		String hdfsInputPath =  outputDir + "/all-frequent-itemsets/freq-list";
		String hdfsOutputPath =  outputDir + "/rule-mining-output";
		Configuration config = new Configuration();
	...
	private void jobAssociationRuleAggregation() throws IOException, ClassNotFoundException, InterruptedException {
		String hdfsInputPath =  outputDir + "/rule-mining-output";
		String hdfsOutputPath =  outputDir + "/final-output";
		Configuration config = new Configuration();
